...
2. The agent loop — the model calls two tools, one after another, deciding for itself when it has enough to answer. Two variants, same question, same folder ([02_agent_loop](02_agent_loop)):
