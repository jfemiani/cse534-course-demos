...
size: 16:9
paginate: true
header: 'CSE 534 - N-Gram Language Models'
footer: '2026'
style: |
  section {
  ...
  h1 {
    color: #941728;
    border-bottom: 3px solid #941728;
  }
  h2 {
    color: #941728;
  }
  ...
  /* Custom style for grayed-out upcoming content */
  .dimmed {
    opacity: 0.3;
  }
---
...
$$p(\text{hello}) = p(h) \cdot p(\text{ello}|h)$$
...
- Can't count them all in training data
...
```bash
cd 03_mathematical_foundations/07_ngram
