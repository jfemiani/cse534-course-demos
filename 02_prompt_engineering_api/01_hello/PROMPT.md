...
Filename 01_hello.py. Send one text input containing “Say hello to CSE 534” through the current OpenAI Responses API and print only the returned text. No conversation loop and no streaming.
