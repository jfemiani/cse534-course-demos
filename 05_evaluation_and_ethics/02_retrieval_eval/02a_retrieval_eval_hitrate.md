# 02a: Which retrieval strategy actually finds the right chunk?
...
`04_tool_use_and_retrieval/03_chunking_retrieval/03a_manual_rag_pipeline.py`
and the vector-vs-keyword comparison from
`04_tool_use_and_retrieval/04_retrieval_approaches/04a_vector_vs_keyword.py`,
combined into one small evaluation.

Compare with `02b_retrieval_eval_examples.py`, which looks at individual
questions instead of the aggregate hit-rate reported here.
